...
def main() -> None:
    ...
    for label, snippet in [
        ...
        ("artifact anonymous upload status", "prepared for anonymous review upload"),
        ...
        ("evidence public url unsupported", "A public anonymous repository URL"),
        ...
        ("artifact gh publish route", "authenticated GitHub CLI"),
