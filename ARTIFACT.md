...
- The generated paper figure comes from `results/local_experiments.csv`.
...
- Before public release, create a fresh repository from this directory or upload
  through an anonymous review service such as anonymous.4open.science.
...
- After anonymous.4open.science returns the review URL, run
